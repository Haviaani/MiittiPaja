<?php
    ...
    switch ($request) {
        ...
        case '/reset':
            ...
            // Seuraavat tarkistukset tarkistavat, että onko vaihtoavain olemassa
            // ja se on vielä aktiivinen. Jos ei, niin tulostetaan käyttäjälle
            // virheilmoitus ja poistutaan.
            require_once MODEL_DIR . 'henkilo.php';
